...
// Functions
bool    ImGui_ImplGe2_Init(void* hwnd)
{
...
static void ImGui_ImplGe2_UpdateMousePos()
{
    ImGuiIO& io = ImGui::GetIO();
...
static void ImGui_ImplGe2_UpdateGamepads()
{
#ifndef IMGUI_IMPL_WIN32_DISABLE_GAMEPAD
    ImGuiIO& io = ImGui::GetIO();
...
extern IMGUI_IMPL_API LRESULT ImGui_ImplGe2_WndProcHandler(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);
#endif
IMGUI_IMPL_API LRESULT ImGui_ImplGe2_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CHAR:
        ...
        return 0;
    case WM_SETCURSOR:
        if (LOWORD(lParam) == HTCLIENT && ImGui_ImplGe2_UpdateMouseCursor())
            return 1;
        return 0;
...
void ImGui_ImplGe2_EnableDpiAwareness()
{
...
float ImGui_ImplGe2_GetDpiScaleForMonitor(void* monitor)
{
...
float ImGui_ImplGe2_GetDpiScaleForHwnd(void* hwnd)
{
    HMONITOR monitor = ::MonitorFromWindow((HWND)hwnd, MONITOR_DEFAULTTONEAREST);
    return ImGui_ImplGe2_GetDpiScaleForMonitor(monitor);
}
...
void ImGui_ImplGe2_EnableAlphaCompositing(void* hwnd)
{
